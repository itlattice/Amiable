...
namespace Amiable.Core
{
    public static class PluginEvents
    {
        ...
        public static int Event_PluginDisabled(AmiableEventArgs eventArgs)
        {
            AmiableEventType amiableEventType = AmiableEventType.PluginDisabled;
        ...
        public static int Event_Restart(AmiableEventArgs eventArgs)
        {
            AmiableEventType amiableEventType = AmiableEventType.Restart;
